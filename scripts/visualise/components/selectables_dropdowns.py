...
def render(app: Dash, combined_data : object):
    ...
    @app.callback(
        [
            Output(component_id=ids.COLUMN_DROPDOWN + "_1", component_property='options'),
            Output(component_id=ids.COLUMN_DROPDOWN + "_2", component_property='options'),
            Output(component_id=ids.COLUMN_DROPDOWN + "_3", component_property='options'),
            ],
        [
            Input(component_id=ids.DATASOURCE_DROPDOWN + "_1", component_property='value'),
            Input(component_id=ids.DATASOURCE_DROPDOWN + "_2", component_property='value'),
            Input(component_id=ids.DATASOURCE_DROPDOWN + "_3", component_property='value'),
        ],
    )
